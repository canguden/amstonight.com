...
const Header = () => {
  ...
  return (
    <div
      ...
      backdrop-blur dark:border-zinc-900 dark:bg-black/80 "
    >
      <div className="mx-auto flex max-w-3xl flex-row items-center justify-between ">
        ...
        <ul className="flex flex-row">
          ...
          <li>
            <div className="mr-5 ">{mounted && <ThemeChanger />}</div>
          </li>
        </ul>
      </div>
    </div>
